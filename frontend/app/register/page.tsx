...
const RegistrationPage = () => {
  ...
  const { request, loading, error, success, message } = useApi();
        ...
        <div className="grid md:grid-cols-2">
          ...
          <div className="hidden md:flex flex-col justify-center p-10 bg-linear-to-br from-indigo-900/50 to-slate-900/50">
            ...
            <p className="mt-6 text-slate-300 text-lg">
              Create your account and access courses, certifications, events,
          ...
          <div className="p-6 sm:p-10">
            <div className="mb-8 text-center">
              ...
              <p className="mt-2 text-slate-400">Register to continue</p>
            </div>
            ...
            {step === "register" ? (
              ...
              >
                <div className="text-center">
                  ...
                  <p className="font-medium text-cyan-400">{registeredEmail}</p>
                </div>
                ...
                >
                  {verifyApi.loading ? "Verifying..." : "Verify OTP"}
                </button>
